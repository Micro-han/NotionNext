...
const BLOG = {
    ...
    NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '596c874c58564846a0a9ea7c50e32095',
    ...
    GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '风花飞有态，烟絮坠无痕',
  
    CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。
  
    AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Micro-han', // 您的昵称 例如 tangly1024
    BIO: process.env.NEXT_PUBLIC_BIO || 'I Love Study', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'https://micro-han.top', // 网站地址
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客', // 网站关键词 英文逗号隔开
    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yxhop666@gmail.com', // 邮箱地址 例如mail@tangly1024.com
    CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
    CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
    CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Micro-han', // 你的github个人主页 例如 https://github.com/tangly1024
    ...
    COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'Micro-han', // 你的用户名 e.g tangly1024
    COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'Micro-han', // 管理员用户名、一般是自己 e.g 'tangly1024'
    COMMENT_GITALK_CLIENT_ID:
        process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_ID || 'c815ba4662451a6ebff3', // e.g 20位ID ， 在gitalk后台获取
    COMMENT_GITALK_CLIENT_SECRET:
        process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_SECRET || '5cb6f22ca1d2daec592cb2e8930c9ad0ba28ff48', // e.g 40位ID， 在gitalk后台获取
